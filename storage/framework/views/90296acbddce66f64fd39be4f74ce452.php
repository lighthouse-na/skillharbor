                ...
                <div class="mt-3 mx-4 flex flex-wrap">
                    ...
                    <div class="w-full px-4 sm:w-1/2 lg:w-6/12 text-grey-500">
                        <div class="grow-0 shrink-0 basis-auto w-10/12 pl-4 md:pl-6 mt-6">
                            ...
                            <p>
                                <strong class="text-indigo-500">Job title: </strong><?php echo e($jcp[0]->position_title); ?>

                            </p>
                            <p>
                                <strong class="text-indigo-500">Job Grade: </strong><?php echo e($jcp[0]->job_grade); ?>

                            </p>

                            <p>
                                <strong class="text-indigo-500">Job Purpose: </strong><?php echo e($jcp[0]->job_purpose); ?>
