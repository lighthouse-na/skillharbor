  ...
  <div class="mx-12 mt-3 space-y-6">
      <div class="grid grid-cols-3 gap-6">
          ...
          <div class="p-4 md:p-5">
              <a href="<?php echo e(route('reports.show', ['id' => Crypt::encrypt($assessment->id)])); ?>">
                  ...
                  <div><p class="text-sky-950 text-sm">View reports from the <?php echo e($assessment->assessment_title); ?> assessment.</p></div>
...
<?php /**PATH /home/hubert/skillharbor-open/resources/views/livewire/reports/select-reports.blade.php ENDPATH**/ ?>