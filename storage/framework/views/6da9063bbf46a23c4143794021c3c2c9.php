        ...
        <div class="grid grid-cols-3 gap-4 rounded-lg mb-4 p-4 sm:p-6 h-full dark:bg-gray-800">
            ...
            <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                ...
                <div class="p-4 md:p-5">
                  ...
                  <a class="mt-3 inline-flex items-center gap-x-1 text-sm font-semibold rounded-lg border border-transparent text-fuchsia-600 hover:text-fuchsia-800 disabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-blue-400 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="<?php echo e(route('assessment.show', ['user' => Auth::user()->id, 'assessment' => $a->id])); ?>">
                    Get Started
...
<?php endif; ?>
<?php /**PATH /home/wings/Telecom/skillharbor-open/resources/views/assessments/index.blade.php ENDPATH**/ ?>