...
<body>
    ...
    <div class="table-container" style="page-break-after: always;">
        ...
        <div class="chart">
            ...
            <img src="https://quickchart.io/chart?width=500&height=300&c=<?php echo e($ageUrl); ?>" alt="Age Chart" />
            <img src="https://quickchart.io/chart?width=500&height=300&c=<?php echo e($genderUrl); ?>" alt="Gender Chart" />
            <img src="https://quickchart.io/chart?width=500&height=300&c=<?php echo e($typeUrl); ?>" alt="Type Chart" />
        </div>
        <table class="organization-table">
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $division->departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <section class="section-title">
        ...
        <img src="https://quickchart.io/chart?width=500&height=300&c=<?php echo e($skillUrl); ?>" />
    </div>

</body>

</html><?php /**PATH /home/hubert/skillharbor-open/resources/views/reports/downloads/organisational_report.blade.php ENDPATH**/ ?>