...
<head>
    ...
    <!--Favicon-->
    <link rel="shortcut icon" href="<?php echo e(asset('images/logos/telecom_namibia_logo.png')); ?>">
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('user-assessment',['user' => Crypt::encrypt(Auth::user()->id)])).'','active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(request()->routeIs('user-assessment')),'icon' => 'iconoir-stackoverflow']); ?>
                    My Assessments
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal2e340925a8bf40d3894bf118093fdd54)): ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3325463566-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /home/wings/Telecom/skillharbor-open/resources/views/layouts/app.blade.php ENDPATH**/ ?>