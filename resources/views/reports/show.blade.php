            ...
            <div>
                        ...
                        <nav class="flex" aria-label="Breadcrumb">
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                                <li class="inline-flex items-center">
                                    <a href="#" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-fuchsia-600 dark:text-gray-400 dark:hover:text-fuchsia-600">
                                ...
                                <li>
                                    <div class="flex items-center">
                                        ...
                                        <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-fuchsia-600 md:ms-2 dark:text-gray-400 dark:hover:text-fuchsia-600">
                                            Skills Audit 2024
                                        </a>
                                    </div>
                                </li>
                ...
                <div class="p-6 bg-gray-50 border-t text-medium text-gray-500 dark:text-gray-400 dark:bg-gray-800 w-full">
                    ...
                    <div class="flex justify-between mb-1">
                        <span class="text-base font-medium text-fuchsia-700 dark:text-white">
                            {{$assessmentProgress["completed"]}}/{{$assessmentProgress["total"]}}
                        </span>
                        <span class="text-sm font-medium text-fuchsia-700 dark:text-white">
