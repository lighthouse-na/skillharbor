<div class="h-screen">
    ...
    <a href="#" class="group block max-w-xs mx-auto rounded-lg p-6 bg-white ring-1 ring-slate-900/5 space-y-3 hover:bg-fuchsia-600 hover:ring-fuchsia-600  transition ease-in-out duration-150">
