    ...
    <div class="h-auto flex flex-col py-4 my-6 px-6 mx-4">
        ...
        <div class="flex flex-col items-center justify-center p-6 my-6 h-full max-h-screen w-full">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 w-full max-h-[90vh] overflow-y-auto">
                        ...
                        <div class="m-2">
                        <div class="flex justify-between items-center rounded-3xl py-4 px-4  bg-gradient-to-br from-white to-zinc-50 border rounded-3xl border-zinc-200 cursor-pointer hover:shadow-lg hover:shadow-sky-200/50 hover:border-sky-400 transition ease-in-out delay-75 duration-300">
                            <a href="{{ route('supervise.list', ['id' => Crypt::encrypt($assessment->id)]) }}" class="flex-1">
                                <div class="flex flex-row items-center">
                                    <div class="rounded-full h-8 w-8 bg-sky-200 mx-3 flex items-center justify-center">
                                        <h1 class="text-sky-800 m-3">{{ $assessment->countSubmittedForReview() }}</h1>
                                    </div>
                                <div class="border-l px-2"><h3 class="text-gray-900 text-lg">{{ $assessment->assessment_title }}</h3>
                                    ...
                                    <div class="mt-2 w-full">
                                        ...
                                        @endphp
                                        <span class="block text-xs font-medium text-gray-500 my-3">
