  ...
  <div class="mx-12 mt-3 space-y-6">
      <div class="grid grid-cols-3 gap-6">
          ...
          <div class="p-4 md:p-5">
              <a href="{{route('supervise.list', ['id' => Crypt::encrypt($assessment->id)])}}">
                  ...
                  <div><p class="text-sky-950 text-sm">View submissions from the {{ $assessment->assessment_title }} assessment.</p></div>
