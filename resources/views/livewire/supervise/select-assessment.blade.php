<div class="h-screen">
    ...
    <a href="{{route('supervise.list', ['id' => Crypt::encrypt($assessment->id)])}}" class="group block w-full mx-auto rounded-lg p-6 bg-white ring-1 ring-slate-900/5 space-y-3 hover:bg-fuchsia-100  transition hover:duration-700 ease-in-out">
