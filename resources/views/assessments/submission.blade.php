            ...
            <div class="container text-gray-950  mx-auto px-6 py-3 rounded-3xl">
                ...
                <div class="mt-3 mx-4 flex flex-wrap">
                    ...
                    <div class="w-full px-4 sm:w-1/2 lg:w-6/12 text-grey-500 mb-10 mt-3">
                        <a class="inline-flex items-center text-sm font-semibold rounded-lg border pb-3 pt-2 px-3 text-fuchsia-600 hover:bg-fuchsia-800 hover:text-white disabled:opacity-50 disabled:pointer-events-none " href="{{route('submission.jcp',['user_id' => Crypt::Encrypt($user->id), 'assessment_id' => Crypt::Encrypt($assessment->id)])}}">
                            Download
                ...
                <table class="mt-6 w-full">
                    <thead >
                        <tr>
                            ...
                            <th class="py-3 px-5 text-left bg-fuchsia-800 text-white font-medium">Competency Rating</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($jcp->skills->groupBy('category.category_title') as $category => $skills)
                        <tr>
                            <td colspan="3" class="py-3 px-5 border-b bg-fuchsia-500 text-white">{{ $category }}</td>
                        </tr>
