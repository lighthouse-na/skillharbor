    ...
    <div class="flex-1 justify-start pb-24 mb-6">
        <div class="container mx-auto p-12 ">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('user.assessment',['user' => Crypt::encrypt($user->id)]) }}"
                                    class="ml-1 text-sm font-medium text-white hover:text-sky-200 md:ml-2 ">My Assessments</a>
                            </div>
                        </li>
                ...
                <div class="mt-3 mx-4 flex">
                        ...
                        <div class="grow-1 shrink-0 basis-auto w-10/12 md:pl-6 mt-6">
                            ...
                            <div class="space-y-3">
                                <p class="text-white text-lg">
                                    <strong class="text-sky-500">Employee Name: </strong>{{ $user->first_name . ' ' . $user->last_name }}
                                </p>
                                <p class="text-white text-lg">
                    ...
                    <div class="w-full px-4 sm:w-1/2 lg:w-6/12 text-white mb-10">
                        <div class="grow-0 shrink-0 basis-auto w-10/12 md:pl-6 mt-6">
                            ...
                            <a class="inline-flex items-center text-sm font-semibold rounded-xl p-3  text-sky-400 hover:bg-sky-800 hover:text-white disabled:opacity-50 disabled:pointer-events-none " href="{{route('supervisor.result',['user_id' => Crypt::Encrypt($user->id), 'assessment_id' => Crypt::Encrypt($assessment->id)])}}">
                                Supervisor Report
            ...
            <div class="flex bg-white border py-6 px-4 rounded-3xl grid mt-12">
                ...
                <div class="mt-6">
                    <!-- Header Section -->
                    <div class="bg-sky-800 text-white font-semibold py-4 px-6 rounded-t-lg shadow-lg">
                        <h2 class="text-xl">Skill Audit Overview</h2>
                    </div>
                    ...
                    <ul class="divide-y divide-gray-200 bg-white border rounded-b-lg">
                        @forelse ($jcp->skills->groupBy('category.category_title') as $category => $skills)
                            ...
                            <li class="py-5 px-6 {{ $index % 2 === 0 ? 'bg-gray-50' : 'bg-white' }} flex justify-between items-center border-b border-gray-200">
                                <!-- Skill Title -->
                                <div class="flex-1">
                                    <h4 class="text-lg font-semibold text-gray-800">{{ $question->skill_title }}</h4>
                                </div>
                                ...
                                <div class="flex-1 text-center">
                                    <span class="block text-sm font-medium text-gray-600">
                                        ...
                                        <span class="block text-sm font-medium bg-red-500 text-white p-2  border border-sky-900">
                                            1
                                        </span>
                                    @elseif ($jcp->skills->find($question->id)->pivot->required_level === 2)
                                        <span class="block text-sm font-medium bg-orange-400 text-white p-2  border border-sky-900">
                                            2
                                        </span>
                                    @elseif ($jcp->skills->find($question->id)->pivot->required_level === 3)
                                        <span class="block text-sm font-medium bg-yellow-300 text-black p-2  border border-sky-900">
                                            3
                                        </span>
                                    @elseif ($jcp->skills->find($question->id)->pivot->required_level === 4)
                                        <span class="block text-sm font-medium bg-green-300 text-black p-2  border border-sky-900">
                                            4
                                        </span>
                                    @elseif ($jcp->skills->find($question->id)->pivot->required_level === 5)
                                        <span class="block text-sm font-medium bg-green-500 text-white p-2  border border-sky-900">
                                            5
                                        </span>
                                    @endif
                                    </span>
