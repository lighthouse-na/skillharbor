            ...
            <x-form-section submit="assessments.store">
                ...
                <x-slot name="form">
                    <div class="mb-4 col-span-6 ">
                        ...
                        <input type="text" name="assessment_title" id="assessment_title" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Enter Assessment Name" required>
                    </div>
